# add geração de audio com streaming
# entender mais das bibliotecas pathlib, speech_recognition, playsound, BytesIO
# apagar fala_assistannt ao final
# salvar todos os audios como chat
